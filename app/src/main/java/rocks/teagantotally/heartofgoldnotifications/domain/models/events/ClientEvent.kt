...
class ClientStatus(val isConnected: Boolean) : ClientEvent
...
sealed class ClientUnsubscription(val topic: String, override val token: IMqttToken?) : TokenizedClientEvent {
...
sealed class ClientMessageReceive() : ClientEvent {
