...
import rocks.teagantotally.heartofgoldnotifications.domain.models.messages.PublishedMessage
...
abstract class MessagePublishedUseCase<ResultType : PublishedMessage>(
