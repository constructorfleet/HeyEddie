...
import rocks.teagantotally.heartofgoldnotifications.presentation.main.fragments.pubish.injection.PublishModule
import javax.inject.Inject

@ActionBarTitle(R.string.title_publish)
class PublishFragment : BaseFragment(), PublishContract.View, OptionsMenuCallbacks {
